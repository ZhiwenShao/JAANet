...
- Prepare the training data
  ...
  - Merge "tools/convert_data.cpp" into Caffe and use it to convert the AU and landmark labels and weights to leveldb or lmdb: the example format of files for AU and landmark labels and weights are in data/examples, in which the weights are shared by all the training samples (only one line needed). 
